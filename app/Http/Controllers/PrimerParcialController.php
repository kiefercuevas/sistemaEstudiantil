...
use App\Students;
use App\Inscribed;
class PrimerParcialController extends Controller
{
    /**
    ...
    public function edit($id)
    {
        ...
        return view('parciales.primerParcial',['alumnos' =>$students,'id'=>$id]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        for($x=0;$x < $names;$x++ ){
          ...
          ->update(['first_midterm' => $request->input('first_midterm')[$x]]);
 

        }
        session::flash('message', 'las calificaciones del primer parcial se han puesto correctamente');
